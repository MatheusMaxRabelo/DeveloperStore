...
public class SaleModifiedNotificationEventHandler(IMessageService messageService) : INotificationHandler<SaleModified>
{
    public async Task Handle(SaleModified notification, CancellationToken cancellationToken)
    {
